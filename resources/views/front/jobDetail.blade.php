                ...
                <div class="card shadow border-0">
                    ...
                    <div class="descript_wrap white-bg">
                        ...
                        <div class="pt-3 text-end">
                            ...
                            @if(Auth::check())
                                <a href="#" onclick="event.preventDefault(); saveJob({{ $job->id }});" class="btn btn-secondary">Save</a>
                            @else
                    ...
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                ...
                                <li>Webite: <span></span><a href="{{ $job->company_website }}">{{ $job->company_website }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
